...
In scope: this package, `crmleaf/savings-calculator`.
...
[advisories]: https://github.com/crmleaf/savings-calculator/security/advisories/new
[calc]: https://github.com/crmleaf/savings-calculator/issues/new?template=calculation-error.yml
