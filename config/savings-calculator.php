...
return [
    ...
    | SAVINGS_CALCULATOR_ROUTE=true, and the tool mounts at
    | /<prefix>/savings-calculator answering both GET and POST.
    |
    */

    'route' => [
        'enabled' => env('SAVINGS_CALCULATOR_ROUTE', false),
        'prefix' => env('SAVINGS_CALCULATOR_PREFIX', 'tools'),
    ...
    */
    ...
    'view' => [
        'title' => 'Payroll Savings Calculator',
    ...
    */
    ...
    'defaults' => [
        ...
        'proposed_annual_platform_fee' => 0,
