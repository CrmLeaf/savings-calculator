/*
 * Progressive enhancement for Payroll Savings Calculator.
 *
...
(function () {
    ...
    var TOOL = 'savings-calculator';
    var CALCULATOR = 'savings';
    var FIELDS = [
        { name: 'employee_count', argument: 'employeeCount', type: 'int' },
        { name: 'current_per_employee_per_month', argument: 'currentPerEmployeePerMonth', type: 'money' },
        { name: 'proposed_per_employee_per_month', argument: 'proposedPerEmployeePerMonth', type: 'money' },
        { name: 'current_annual_platform_fee', argument: 'currentAnnualPlatformFee', type: 'money' },
        { name: 'proposed_annual_platform_fee', argument: 'proposedAnnualPlatformFee', type: 'money' },
        { name: 'migration_cost', argument: 'migrationCost', type: 'money' },
        { name: 'contract_months', argument: 'contractMonths', type: 'int' },
    ];
